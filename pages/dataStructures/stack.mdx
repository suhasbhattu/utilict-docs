...
Stack is the linear data structure which is able to perform operation in LIFO (Last In First Out) or FILO (First In Last Out) way. quarkle supports following methods on `Stack`:
