...
Matrix is used in various operations in statistics and analytics. quarkle supports matrices with following operations.
...
```js copy
scalarMatrixMultiplication([[1, 6],[9, 3],[6, 0]],-2); // Multiplies -2 with a given matrix and returns [[-2, -12],[-18, -6],[-12, 0]]
```
...
```js copy
matrixTranspose([[0, 4],[7, 0],[3, 1]]); // Returns [[0, 7, 3],[4, 0, 1]]
```
